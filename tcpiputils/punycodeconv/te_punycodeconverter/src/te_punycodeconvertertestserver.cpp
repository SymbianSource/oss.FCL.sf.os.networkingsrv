...
#include "te_punycodeconvertertestserver.h"
...
@internalTechnology
*/
CPunycodeConverterTestServer* CPunycodeConverterTestServer::NewL()
	{
	CPunycodeConverterTestServer* server = new (ELeave) CPunycodeConverterTestServer();
...
@internalTechnology
*/
CTestBlockController* CPunycodeConverterTestServer::CreateTestBlock()
	{
...
@internalTechnology
*/
CTestBlockController* CPunycodeConverterTestServer::CreateTestBlockL()
	{
	return new (ELeave) CPunycodeConverterTestBlock();
	}
...
LOCAL_C void MainL()
	...
	CPunycodeConverterTestServer* server = NULL;
	TRAPD(err, server = CPunycodeConverterTestServer::NewL());
	if(!err)
		{
