...
/**
 @file te_tundrivertestblock.cpp
 @internalTechnology
*/
...
*/
CDataWrapper* CTunDriverTestBlock::CreateDataL(const TDesC& aData)
	{
	CDataWrapper* wrapper = NULL;
	if (KTunDriverTestWrapper() == aData)
		{
		wrapper = CTunDriverTestWrapper::NewL();
		}
	return wrapper;
	}
